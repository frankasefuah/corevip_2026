...
const i18n = {
  ...
  fr: {
    ...
    countdown: {
      ...
      title: "Le CoREViP 2027 débute dans",
      text: `Compte à rebours avant l'ouverture de ${EVENT_CONTENT.code}.`,
      days: "Jours",
      hours: "Heures",
      minutes: "Minutes",
      seconds: "Secondes",
    ...
    speakers: {
      ...
      title: "Conférenciers vedettes",
      text: "",
    },
    gallery: {
      eyebrow: "Visitez le Kenya",
      title: "Le CoREViP : lieu, galerie et expérience",
      text: "",
      mapTitle: "Safari Park Hotel",
      mapText: "",
    ...
    videos: {
      eyebrow: "Vidéos",
      title: "Découvrez CoREViP : extraits vidéo de la conférence",
      text: "",
    },
    testimonials: {
      eyebrow: "Témoignages",
    ...
    partners: {
      eyebrow: "Partenaires de l'événement",
      title: "Panneau des partenaires stratégiques et des parties prenantes",
      text: "",
    },
    exhibitors: {
      eyebrow: "Salon et vitrine",
      title: "Les temps forts du salon de l'innovation et du savoir",
    ...
    hotels: {
      eyebrow: "Hébergement",
      title: "Hôtels",
      text: "Voici quelques hôtels situés à proximité du CoREViP Event Center",
    },
    registration: {
      eyebrow: "Inscription",
      ...
      cardText:
        "Assurez-vous de pouvoir participer à la conférence « Diamond Jubilee » de l'AAU.",
    ...
    tickets: {
      ...
      text: "Remise spéciale pour 2 participants supplémentaires.",
    },
    contact: {
      eyebrow: "Contact",
      ...
      sponsorship: "Contact pour le parrainage",
      note: "Nous serons ravis de vous lire. N'hésitez pas à nous contacter en utilisant les coordonnées indiquées.",
    },
    faq: {
      eyebrow: "FAQ",
  ...
  ar: {
    ...
    contact: {
      ...
      note: "يسعدنا أن نتلقى رسالتك. يرجى التواصل معنا باستخدام بيانات الاتصال المذكورة.",
    },
    faq: {
...
const hotels = [
  ...
  {
    name: "Regional Centre for Mapping of Development of Resources (RCMRD)",
    stars: 3,
    area: "Westlands",
    price: 105,
    tag: "Value",
