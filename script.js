...
const i18n = {
  en: {
    ...
    about: {
      ...
      text2:
        "The conference combines high-level policy dialogue, academic sessions, communities of practice, innovation exhibition, and commitments for the future African university.",
    ...
    gallery: {
      eyebrow: "Visit Kenya",
      title: "The CoREViP Venue, Gallery & Experience",
      text: "",
      mapTitle: "Safari Park Hotel",
      mapText: "",
    ...
    registration: {
      ...
      info3: `Full paper deadline: ${EVENT_CONTENT.submissionFullPaper}`,
    ...
    contact: {
      eyebrow: "Contact",
      title: "Conference contact, exhibition, and sponsorship enquiries",
      text: "This section sits beneath the tickets area as requested.",
      email: "Email",
      phone: "Phone",
  ...
  fr: {
    ...
    about: {
      ...
      text2:
        "La conférence combine dialogue politique de haut niveau, sessions académiques, communautés de pratique, exposition d’innovation et engagements pour l’université africaine de demain.",
    ...
    gallery: {
      eyebrow: "Lieu & galerie",
      title: "Aperçu du lieu, carte Google et atmosphère de la conférence",
      text: "La carte du lieu est fusionnée dans cette section. Remplacez les images d’exemple par de vraies photos du lieu ou de l’événement.",
      mapTitle: "Localisation du lieu",
      mapText: `Aperçu cartographique pour ${EVENT_CONTENT.venue}. Remplacez la requête de la carte dans script.js si nécessaire.`,
    },
    videos: {
      eyebrow: "Vidéos",
      title: "Vidéos intégrées pour teasers et messages officiels",
    ...
    hotels: {
      ...
      title: "Options d’hébergement avec filtres et mise en page en curseur",
      text: "Cette section utilise par défaut la version curseur. Remplacez les hôtels de démonstration par les partenaires officiels.",
    },
    registration: {
      eyebrow: "Inscription",
      ...
      button2: "Ouvrir l’appel à communications",
      note: "Ce bouton pointe actuellement vers un espace réservé (#). Remplacez-le dans script.js avec EVENT_CONTENT.registrationLink.",
      infoTitle: "Dates importantes",
      info1: `Date limite des résumés : ${EVENT_CONTENT.submissionAbstract}`,
      info2: `Notification d’acceptation : ${EVENT_CONTENT.submissionAcceptance}`,
      info3: `Date limite de l’article complet : ${EVENT_CONTENT.submissionFullPaper}`,
      info4: `Contact : ${EVENT_CONTENT.contactEmail}`,
    },
    tickets: {
    ...
    contact: {
      eyebrow: "Contact",
      title: "Contact conférence, exposition et sponsoring",
      text: "Cette section se trouve sous la zone des tarifs comme demandé.",
      email: "Email",
      phone: "Téléphone",
      exhibition: "Contacter pour l’exposition",
      sponsorship: "Contacter pour le sponsoring",
      note: "Mettez à jour les emails et le numéro de téléphone dans EVENT_CONTENT dans script.js.",
    },
    faq: {
      eyebrow: "FAQ",
      title: "Questions fréquemment posées",
      text: "Une section accordéon simple pour les questions courantes sur la participation, les voyages et les soumissions.",
    },
    blog: {
      eyebrow: "Mises à jour",
      title: "Avis récents, appels et aperçus",
      text: "Utilisez cette section pour les mises à jour, l’appel à communications, la logistique et les annonces.",
    },
  },
  ar: {
    langName: "العربية",
    ...
    about: {
      ...
      text2:
        "يجمع المؤتمر بين الحوار السياساتي رفيع المستوى والجلسات الأكاديمية ومجتمعات الممارسة ومعرض الابتكار والتزامات المستقبل للجامعة الأفريقية.",
    ...
    gallery: {
      eyebrow: "المكان والمعرض",
      title: "معاينة المكان وخريطة جوجل وأجواء المؤتمر",
      text: "تم دمج خريطة المكان داخل هذا القسم. استبدل الصور التجريبية بصور حقيقية من assets/images.",
      mapTitle: "موقع المكان",
      mapText: `معاينة خرائط لـ ${EVENT_CONTENT.venue}. يمكنك تعديل استعلام الخريطة في script.js للحصول على دقة أكبر.`,
    },
    videos: {
      eyebrow: "الفيديوهات",
    ...
    hotels: {
      eyebrow: "فنادق الحجز",
      title: "خيارات إقامة مع التصفية والتخطيط المنزلق",
      text: "يستخدم هذا القسم افتراضيًا النسخة المنزلقية. استبدل الفنادق التجريبية بالشركاء الرسميين.",
    },
    registration: {
      eyebrow: "التسجيل",
      ...
      button2: "فتح الدعوة لتقديم الأوراق",
      note: "يشير هذا الزر حاليًا إلى عنصر بديل (#). استبدله في script.js باستخدام EVENT_CONTENT.registrationLink.",
      infoTitle: "تواريخ مهمة",
      info1: `آخر موعد للملخصات: ${EVENT_CONTENT.submissionAbstract}`,
      info2: `إشعار القبول: ${EVENT_CONTENT.submissionAcceptance}`,
      info3: `آخر موعد للورقة الكاملة: ${EVENT_CONTENT.submissionFullPaper}`,
      info4: `التواصل: ${EVENT_CONTENT.contactEmail}`,
    },
    tickets: {
    ...
    contact: {
      eyebrow: "التواصل",
      title: "التواصل بشأن المؤتمر والمعرض والرعاية",
      text: "يقع هذا القسم أسفل منطقة الرسوم كما طلبت.",
      email: "البريد الإلكتروني",
      phone: "الهاتف",
      exhibition: "التواصل للمعرض",
      sponsorship: "التواصل للرعاية",
      note: "حدّث عناوين البريد ورقم الهاتف داخل EVENT_CONTENT في script.js.",
    },
    faq: {
      eyebrow: "الأسئلة الشائعة",
      title: "الأسئلة المتكررة",
      text: "قسم أكورديون بسيط للأسئلة الشائعة حول المشاركة والتسجيل والسفر والتقديم.",
    },
    blog: {
  ...
  pt: {
    ...
    about: {
      ...
      text2:
        "A conferência combina diálogo político de alto nível, sessões académicas, comunidades de prática, exposição de inovação e compromissos para a universidade africana do futuro.",
    ...
    gallery: {
      eyebrow: "Local & galeria",
      title:
        "Pré-visualização do local, mapa Google e atmosfera da conferência",
      text: "O mapa do local foi integrado nesta secção. Substitua as imagens de exemplo por fotos reais em assets/images.",
      mapTitle: "Localização do venue",
      mapText: `Pré-visualização do mapa para ${EVENT_CONTENT.venue}. Substitua a consulta do mapa em script.js se desejar maior precisão.`,
    },
    videos: {
      eyebrow: "Vídeos",
    ...
    hotels: {
      ...
      title: "Opções de alojamento com filtros e layout em slider",
      text: "Esta secção usa por defeito a versão slider. Substitua os hotéis de demonstração por parceiros oficiais.",
    },
    registration: {
      eyebrow: "Registo",
      ...
      button2: "Abrir chamada para resumos",
      note: "Este botão aponta atualmente para um marcador (#). Substitua-o em script.js usando EVENT_CONTENT.registrationLink.",
      infoTitle: "Datas importantes",
      info1: `Prazo para resumos: ${EVENT_CONTENT.submissionAbstract}`,
      info2: `Notificação de aceitação: ${EVENT_CONTENT.submissionAcceptance}`,
      info3: `Prazo para artigo completo: ${EVENT_CONTENT.submissionFullPaper}`,
      info4: `Contacto: ${EVENT_CONTENT.contactEmail}`,
    },
    tickets: {
    ...
    contact: {
      eyebrow: "Contacto",
      title: "Contacto da conferência, exposição e patrocínio",
      text: "Esta secção aparece abaixo da área de preços, como solicitado.",
      email: "Email",
      phone: "Telefone",
      exhibition: "Contactar para exposição",
      sponsorship: "Contactar para patrocínio",
      note: "Atualize os emails e o número de telefone em EVENT_CONTENT dentro de script.js.",
    },
    faq: {
      eyebrow: "FAQ",
      title: "Perguntas frequentes",
      text: "Uma secção em acordeão para dúvidas comuns sobre participação, registo, viagem e submissão.",
    },
    blog: {
      eyebrow: "Atualizações da conferência",
      title: "Avisos recentes, chamadas e prévias",
      text: "Use esta secção para atualizações, chamada de trabalhos, logística e anúncios.",
    },
  },
};
...
const faqs = [
  {
    ...
    a: {
      ...
      fr: "Les dirigeants universitaires, décideurs, chercheurs, étudiants, agences d’assurance qualité, partenaires industriels et agences de développement sont encouragés à participer.",
      ar: "يشجع على المشاركة قادة الجامعات وصناع السياسات والباحثون والطلبة وهيئات الجودة والشركاء الصناعيون والجهات التنموية.",
      pt: "Líderes universitários, decisores, investigadores, estudantes, agências de qualidade, parceiros da indústria e agências de desenvolvimento são incentivados a participar.",
    },
  },
  {
    q: {
      en: "How can I submit an abstract?",
      fr: "Comment puis-je soumettre un résumé ?",
      ar: "كيف يمكنني تقديم ملخص؟",
      pt: "Como posso submeter um resumo?",
    },
    a: {
      en: `Use the official submission portal. The abstract deadline is ${EVENT_CONTENT.submissionAbstract}.`,
      fr: `Utilisez le portail officiel de soumission. La date limite des résumés est le ${EVENT_CONTENT.submissionAbstract}.`,
      ar: `استخدم بوابة التقديم الرسمية. آخر موعد للملخصات هو ${EVENT_CONTENT.submissionAbstract}.`,
      pt: `Use o portal oficial de submissão. O prazo para resumos é ${EVENT_CONTENT.submissionAbstract}.`,
    },
  },
  {
    q: {
      en: "Will there be exhibition and partnership opportunities?",
      fr: "Y aura-t-il des opportunités d’exposition et de partenariat ?",
      ar: "هل ستكون هناك فرص للعرض والشراكات؟",
      pt: "Haverá oportunidades de exposição e parceria?",
    },
    a: {
      en: "Yes. The conference includes an innovation and knowledge expo, and the contact section provides buttons for exhibition and sponsorship enquiries.",
      fr: "Oui. La conférence comprend une expo innovation et savoir, et la section contact fournit des boutons pour les demandes liées à l’exposition et au sponsoring.",
      ar: "نعم. يتضمن المؤتمر معرضًا للابتكار والمعرفة، ويوفر قسم التواصل أزرارًا للاستفسار حول المعرض والرعاية.",
  ...
  {
    q: {
      en: "Where can I find accommodation options?",
      fr: "Où puis-je trouver les options d’hébergement ?",
      ar: "أين يمكنني العثور على خيارات الإقامة؟",
      pt: "Onde posso encontrar opções de alojamento?",
    },
    a: {
      en: "In the hotels section. This updated build defaults to a hotel slider with filters for area and hotel type.",
      fr: "Dans la section hôtels. Cette version utilise par défaut un curseur d’hôtels avec filtres par zone et type.",
      ar: "في قسم الفنادق. تعتمد هذه النسخة افتراضيًا على منزلق للفنادق مع عوامل تصفية حسب المنطقة والنوع.",
      pt: "Na secção de hotéis. Esta versão usa por defeito um slider com filtros por área e tipo de hotel.",
    },
  },
];
...
function renderProgram() {
  ...
  const activeDay =
    schedule.find((day) => day.key === state.programDay) ?? schedule[0];
  const html =
    variant === "v1"
      ? `
        ...
        <div class="speaker-grid ${variant}">
          ${speakers
            .map((speaker, index) => {
              const imageValue =
                speaker.image ||
                svgPortrait(speaker.name, speaker.role, speaker.colors);
...
function renderGallery() {
  ...
  const currentFilterLabel =
    state.galleryFilter === "All" ? t("common.all") : state.galleryFilter;
  const items =
        ...
        <div class="gallery-toolbar reveal">
          ...
          <div class="gallery-filters">
            ${categories
              .map((category) => {
                const rawValue =
                  category === t("common.all") ? "All" : category;
...
function handleClick(event) {
  ...
  switch (action) {
    ...
    case "hotel-slide": {
      ...
      track.scrollBy({
        left: direction * Math.max(track.clientWidth * 0.85, 320),
        behavior: "smooth",
      });
      break;
    }
...
function initAssetFallbacks() {
  ...
  document.querySelectorAll(".media-fallback").forEach((el) => {
    ...
    if (
      !urlMatch ||
      !urlMatch[1] ||
      urlMatch[1].startsWith("data:image/svg+xml")
    )
      return;
    const testImg = new Image();
    testImg.onerror = () => {
      el.style.backgroundImage = `url('${el.dataset.fallback}')`;
    };
